...
def tracker_tab() -> rx.Component:
    return rx.vstack(
        ...
        rx.grid(
            rx.box(
                rx.vstack(
                    rx.text("Validation", color=MUTED, font_size="0.8rem", text_transform="uppercase", letter_spacing="0.08em"),
                    rx.button(
                        "Validate active step",
                        on_click=TrackerState.validate_active_step,
                        background="#163327",
            ...
            rx.box(
                rx.vstack(
                    rx.text("Rollback", color=MUTED, font_size="0.8rem", text_transform="uppercase", letter_spacing="0.08em"),
                    rx.button(
                        "Unvalidate active step",
                        on_click=TrackerState.unvalidate_active_step,
                        background="#3a1c2a",
        ...
        rx.text(TrackerState.validated_steps_label, color=MUTED, width="100%"),
        rx.hstack(
